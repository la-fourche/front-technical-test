    ...
    value: function componentDidMount() {
      ...
      if (d.length === 0) {
        if (verif.length < 0) {
          ...
          console.log('ger');
          axios__WEBPACK_IMPORTED_MODULE_9___default.a.get("http://0.0.0.0:8080/products?id=".concat(myParam)).then(function (_ref) {
            var headers = _ref.headers,
                data = _ref.data;
            console.log(data, "http://0.0.0.0:8080/products?id=".concat(myParam));
            self.setState({
              product: data
            });
          });
...
//# sourceMappingURL=product.js.79c47ff3585add19f9b1.hot-update.js.map