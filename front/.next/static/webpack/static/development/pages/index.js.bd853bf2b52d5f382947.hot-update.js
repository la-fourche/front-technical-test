...
function (_React$Component) {
  ...
  Object(_babel_runtime_corejs2_helpers_esm_createClass__WEBPACK_IMPORTED_MODULE_4__["default"])(Home, [{
    ...
    value: function componentDidMount() {
      var self = this;
      axios__WEBPACK_IMPORTED_MODULE_11___default.a.get("http://0.0.0.0:8080/products/?_page=&_limit=20").then(function (_ref) {
        var headers = _ref.headers,
            data = _ref.data;
        var pages_ = _babel_runtime_corejs2_core_js_parse_int__WEBPACK_IMPORTED_MODULE_2___default()(headers['x-total-count']) / 20;
        self.setState({
          pages: pages_
        });
        self.props.dispatch({
          ...
          while (1) {
            switch (_context.prev = _context.next) {
              ...
              case 2:
                ...
                data = _ref2.data;
                pages_ = _babel_runtime_corejs2_core_js_parse_int__WEBPACK_IMPORTED_MODULE_2___default()(headers['x-total-count']) / 20;
...
//# sourceMappingURL=index.js.bd853bf2b52d5f382947.hot-update.js.map